              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    labTestItemDetails(categoroy:"Referrer commission(tk)", data: widget.refferCommission?.toInt()),
                    labTestItemDetails(categoroy:"Charge price", data: widget.chargePrice?.toInt()),
