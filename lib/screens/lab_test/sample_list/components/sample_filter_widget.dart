  ...
  void initState() {
    loginPreference
      ...
      if( value.serviceId != null){
        sampleVM.isFilterClear.value = true;
      }
    }));
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Visibility(
                              visible: sampleVM.isFilterClear.value,
                              child: InkWell(
                                  onTap: (){
                                    setState(() {
                                   ...
                                   /*   loginPreference.getServiceId().then(
                                      ...
                                      sampleVM.isFilterClear.value = false;
                                        sampleVM.invoNumController.value.clear();
    ...
    await showDialog(
        ...
        builder: (context) {
          return StatefulBuilder(
            ...
            builder: (context, StateSetter setStates) => SingleChildScrollView(
              child: AlertDialog(
                title: Row(
                  mainAxisAlignment: MainAxisAlignment.end,
                  children: [
