...
class _SummeryListFilterWidgetState extends State<SummeryListFilterWidget> {
    ...
    loginPreference
        ...
        .then((value) => setState((){
          if( value.serviceId != null){
            summeryVm.isFilterClear.value = true;
          }
    }));
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Visibility(
                            visible: summeryVm.isFilterClear.value,
                            child: InkWell(
                                onTap: () {
                                  setState(() {
                                    ...
                                    summeryVm.startDate =
                                        DateFormat("yyyy-MM-dd")
                                            .format(DateTime.now());
                                    summeryVm.endDate = DateFormat("yyyy-MM-dd")
                                        .format(DateTime.now());

                                    summeryVm.getSummeryListData();
                                    summeryVm.statusName.value = "All";
                                    summeryVm.isFilterClear.value = false;
                                    labTestSuggName = '';
                ...
                content: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      ExpansionTile(
                        leading: Text("${summeryVm.statusName.value}",
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          InkWell(
                                              onTap: () {
                                                setStates(() {
                                                  summeryVm.categoryId.value =
                                                      0;
                                                  summeryVm.statusName.value =
                                                      "All";
                                                  summeryVm
                                                      .getSummeryListData();
                                                });
                                      ...
                                      Container(
                                        ...
                                        child: ListView.separated(
                                          shrinkWrap: true,
                                          itemCount: summeryFilterVM
                                              .summeryListFilterStatus
                                              .value
                                              .length,
                                                ...
                                                child: Container(
                                                  child: InkWell(
                                                      onTap: () {
                                                        setStates(() {
                                                          isClick = true;
                                                          statusId = summeryFilterVM
                                                              .summeryListFilterStatus[
                                                                  index]
                                                              .id;
                                                          summeryVm.statusName
                                                                  .value =
                                                              summeryFilterVM
                                                                  .summeryListFilterStatus[
                                                                      index]
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          Text(
                                                              ...
                                                              style: TextStyle(
                                                                  color: (summeryVm.categoryId.value == summeryFilterVM.summeryListFilterStatus[index].id &&
                                                                          statusId !=
                                                                              0)
                                                                      ? Colors
                                                                          .red
                          ...
                          builder: (contxt, data) {
                            return Autocomplete<LabTestNameSuggModel>(
                              ...
                              onSelected: (selectedValue) {
                                ...
                                print(
                                    "select id ${selectedValue.medicalTypeId}");
  ...
  void scanQRCode() async {
    try {
      final brCode = await FlutterBarcodeScanner.scanBarcode(
