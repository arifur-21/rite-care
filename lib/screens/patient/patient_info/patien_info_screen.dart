                  ...
                  return Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        PatientInfoCardWidget(
                          ...
                          editOnTap: (){
                            ...
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>  RegistrationUpdateScreen(
                              ...
                              serviceType: (data[index].serviceType == 0) ?"Uniform" : (data[index].serviceType == 1) ? "RE" :(data[index].serviceType == 3)? "CNE" : "",
                        ...
                        ProfileUserDataViewWidget(title: "Service Type",information: "${(data[index].serviceType == 0) ?"Uniform" : (data[index].serviceType == 1) ? "RE" :(data[index].serviceType == 3)? "CNE" : ""}"),
