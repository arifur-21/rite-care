...
import '../../patient_registration/update/update_full_form_register_screen.dart';
                      ...
                      children: [
                        ...
                        PatientInfoCardWidget(
                          ...
                          editOnTap: (){
                            ...
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>  UpdaeRegistrFullForm(
                              officalNo: data[index].officalNo.toString(),
                              serviceTypeId: data[index].serviceType,
                              ...
                              serviceType: (data[index].serviceType == 0) ?"Uniform" : (data[index].serviceType == 1) ? "RE" :(data[index].serviceType == 2)? "CNE" : "",
                              headerText: "Update Patient",
                              patientOldId:data[index].patientOldId,
                        ...
                        ProfileUserDataViewWidget(title: "Name",information: "${data[index].name??""} ${data[index].lastName??""}"),
                        ProfileUserDataViewWidget(title: "Gender",information: "${data[index].gender??""} "),
                        ...
                        ProfileUserDataViewWidget(title: "Patient Old Id",information: "${data[index].patientOldId??""}"),
                        ...
                        ProfileUserDataViewWidget(title: "Service Type",information: "${(data[index].serviceType == 0) ?"Uniform" : (data[index].serviceType == 1) ? "RE" :(data[index].serviceType == 2)? "CNE" : ""}"),
