          ...
          children: [
            ...
            Expanded(
                ...
                Column(
                  ...
                  Text((widget.DateOfBirth == null) ? " " : DateFormat('dd-MM-yyyy').format(DateTimeConverter.dateOfTiemConterter(widget.DateOfBirth)), style: TextStyle( fontSize: 14, color: Styles.textGreen),),
                  ],)),
            Expanded(
                flex: 1,
                child: Center(
