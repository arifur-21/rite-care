                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Obx(() {
                                  return Text(
                                      "${patinetListVM.patientList.value.total}");
                                }),
                              ],
                            )
                          ],
                                ...
                                return Column(
                                  children: [
                                    PatientCartListViewWidgets(
                                        patientId: patinetListVM
                                            .items![index].id
                                            .toString(),
                                        PatientName: patinetListVM
                                                .items![index].firstName
                                                .toString() +
                                            ' ' +
                                            patinetListVM.items![index].lastName
                                                .toString(),
                                        DateOfBirth:
                                            patinetListVM.items![index].dOB,
                                        onTap: () {
                                          ServiceIdModel serviceIdModel =
                                              ServiceIdModel(
                                                  serviceId: patinetListVM
                                                      .items![index].id);

                                          loginPreference
                                              .saveServiceId(serviceIdModel);

                                          setState(() {
                                            final data = SearchUserModel(
                                              id: patinetListVM
                                                  .items![index].id,
                                              cellNo: patinetListVM
                                                  .items![index].phoneNumber,
                                              name: patinetListVM
                                                  .items![index].firstName,
                                              lastName: patinetListVM
                                                  .items![index].lastName,
                                              city: patinetListVM
                                                  .items![index].city,
                                              street: patinetListVM
                                                  .items![index].street,
                                              officalNo: patinetListVM
                                                  .items![index].serviceId,
                                              patientId: patinetListVM
                                                  .items![index].id,
                                              gender: patinetListVM
                                                  .items![index].gender?.name,
                                              email: patinetListVM
                                                  .items![index].email,
                                              dob: patinetListVM
                                                  .items![index].dOB,
                                              bloodGroup: patinetListVM
                                                  .items![index].bloodGroup,
                                              mobile: patinetListVM
                                                  .items![index].phoneNumber,
                                              emergencyContact: patinetListVM
                                                  .items![index]
                                                  .emergencyNumber,
                                              emergencyRelation: patinetListVM
                                                  .items![index]
                                                  .emergencyContactRelation,
                                              emergencyName: patinetListVM
                                                  .items![index]
                                                  .emergencyContactName,
                                              nationalId: patinetListVM
                                                  .items![index].nationalId
                                                  .toString(),
                                              relationship: patinetListVM
                                                  .items![index]
                                                  .relationship
                                                  ?.name,
                                              rank: patinetListVM
                                                  .items![index].rank?.name,
                                              unit: patinetListVM
                                                  .items![index].unit?.name,
                                              patienStatus: patinetListVM
                                                  .items![index].patientStatus,
                                              patientPrefix: patinetListVM
                                                  .items![index]
                                                  .patientPrefix
                                                  ?.name,
                                              serviceType: patinetListVM
                                                  .items[index].serviceTypeId,
                                              isRetired: patinetListVM
                                                  .items[index].isRetired,
                                              rankId: patinetListVM
                                                  .items[index].rankId,
                                              unitId: patinetListVM
                                                  .items[index].unitId,
                                              statusId: patinetListVM
                                                  .items[index].patientStatusId,
                                              prefixId: patinetListVM
                                                  .items[index].patientPrefixId,
                                              relationId: patinetListVM
                                                  .items[index].relationshipId,
                                              genderId: patinetListVM
                                                  .items[index].genderId,
                                              bloodGroupId: patinetListVM
                                                  .items[index].bloodGroupId,
                                              patientOldId: patinetListVM
                                                  .items[index].oldId
                                            );
