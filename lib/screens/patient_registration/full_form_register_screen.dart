...
class RegistrFullForm extends StatefulWidget {
  ...
  RegistrFullForm( {this.officalNo,
    this.gender,
    this.bloodGroup,
    this.address,
    this.mobile,
...
class _RegistrFullFormState extends State<RegistrFullForm> {
  ...
  String headerText = 'Patient Registration';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
                  ...
                  RoundedButton(
                    ...
                    onTap: () {
                      ...
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => RegistrShortForm(officalNum: widget.officalNo,)));
                    },
                  ),
                ],
              ),
              ...
              (headerText == 'Update Patient') ?  RoundedButton(
                  width: Get.width * 0.4,
                  title: "Update",
                  color: Styles.primaryColor,
                  onTap: () {
              ...
              RoundedButton(
                  ...
                  onTap: () {
                    setState(() {
                      if(selectGender == ''){
                        isColor = Colors.red;
                        genderSelectChecktTxt = "Select gender";
                      }else{
                        genderSelectChecktTxt = " ";
                        isColor = Styles.textGreen;
                      }
                    });
