...
class RegistrShortForm extends StatefulWidget {
  ...
  RegistrShortForm({this.officalNum});
}
...
class _RegistrShortFormState extends State<RegistrShortForm> {
  ...
  Widget build(BuildContext context) {
    print("offical num ${widget.officalNum}");
    return Scaffold(
      drawer: Drawer(
        child: DrawerWidget(),
      ),
                        ...
                        child: InkWell(
                            ...
                            child: Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    color: Colors.white),
                                child:
                                    Icon(Icons.add_a_photo_rounded, size: 25))),
                      ),
                    ],
                  ),
                      ...
                      child: Column(
                        children: [
                          ...
                          (inputServiceId == resServiceId &&
                                  shortFormVM.short_officalNOController.value
                                      .text.isNotEmpty)
                              ? Row(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  children: [
                          ...
                          ResuableTextField(
                              controllerValue:
                                  shortFormVM.short_emailController.value,
                              hintText: "EMAIL"),
                          SizedBox(
                            height: 15,
                          ),
