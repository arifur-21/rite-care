...
class UpdaeRegistrFullForm extends StatefulWidget {
  dynamic officalNo;
  dynamic gender;
  dynamic bloodGroup;
  dynamic address;
  ...
  UpdaeRegistrFullForm( {this.officalNo,
    this.gender,
    this.bloodGroup,
    this.address,
    this.mobile,
  ...
  @override
  State<UpdaeRegistrFullForm> createState() => _UpdaeRegistrFullFormState();
}

class _UpdaeRegistrFullFormState extends State<UpdaeRegistrFullForm> {
 ...
 /*   registerVM.officalNOController.value.clear();
    ...
    registerVM.patientOldIdController.value.text = widget.patientOldId.toString();
  ...
  Widget build(BuildContext context) {
    print("service id133 ${widget.serviceType}");
    return Scaffold(
      drawer: Drawer(
        child: DrawerWidget(),
      ),
              ...
              Row(
                ...
                children: [
                  RoundedButton(
                    ...
                    onTap: () {
                    //  Navigator.pop(context);
                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => UpdaeRegistrShortForm(
                        officalNo: widget.officalNo,
                        serviceTypeId: widget.serviceTypeId,
                        serviceType: widget.serviceType,
                        servicerId: widget.servicerId,
                        relationId: widget.relationId,
                        prefixId: widget.prefixId,
                        patientPrefix: widget.patientPrefix,
                        patientRelation: widget.patientRelation,
                        statusId: widget.statusId,
                        patientStatus: widget.patientStatus,
                        rank: widget.rank,
                        rankId: widget.rankId,
                        ...
                        genderId: widget.genderId,
                        bloodGgroupName: widget.bloodGgroupName,
                        bloodGroup: widget.bloodGroup,
                        bloodGroupId: widget.bloodGroupId,
                        phone: widget.phone,
                        email: widget.email,
                        dob: widget.dob,
                        patientOldId: widget.patientOldId.toString(),
              ...
              Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      ResuableTextField(
                          controllerValue:
                              registerVM.patientOldIdController.value,
                      ...
                      ResuableTextField(
                          controllerValue:
                              registerVM.nationalIdController.value,
                      ...
                      ResuableTextField(
                          controllerValue:
                              registerVM.emergencyContactNumberController.value,
                      ...
                      ResuableTextField(
                          controllerValue:
                              registerVM.emergencyNameContactController.value,
                          hintText: "Emergency contact name"),
                      SizedBox(
                        height: 15,
                      ),
                      ResuableTextField(
                          controllerValue: registerVM
                              .emergencyContactRelationController.value,
