...
class _PatientSearchState extends State<PatientSearch> {
 ...
 bool isCheck = false;
  ...
  @override
  void dispose() {
   searchVM.patientOfficialNumberController.value.dispose();
   searchVM.patientNameController.value.dispose();
   searchVM.patientCellNoController.value.dispose();
   searchVM.patienidController.value.dispose();
                  ...
                  child: Column(
                    children: [
                      ...
                      ResuableTextField(
                          ...
                          errorMsg: "Please Enter Patient Mobile No",
                          controllerValue:  searchVM.patientCellNoController.value,
                          icon: Icons.search_outlined,
                          hintText: "Patient Mobile No"),
              ],)),
