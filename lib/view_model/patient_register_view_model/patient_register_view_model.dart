...
class PatientRegisterViewModel extends GetxController {
  ...
  void registerPatientFullForm({
    ...
    print("national id${serviceTypeId}");
  ...
  Future<List<dynamic>> getPhoneNumber() async {
    var data;
    ...
    final response =
    await http.get(Uri.parse('https://mobileapp.rite-hms.com/Patient/GetPatientByPhone?phoneNumber=171250532991'), headers: {
