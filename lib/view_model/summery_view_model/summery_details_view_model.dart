...
class SummeryDetailsViewModel extends GetxController{
  ...
  /// get table row design item
   Future<TableRowDesignModel> getTableRowDesignItem(serviceId, itemId, groupItemId, patientServiceIds) async {
     print('call table row design vm ');
    setRxRequestStatus(Status.LOADING);
    await _api.getTableRowDesignItem(serviceId, itemId,groupItemId, patientServiceIds).then((value) {
